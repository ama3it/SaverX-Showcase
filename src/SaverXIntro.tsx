        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="flex flex-col justify-center space-y-6 text-gray-600 dark:text-gray-400">
            ...
            <p className="text-base leading-relaxed">
              Welcome to the interactive demo of SaverX, our AI product designed for intelligent 
              energy optimization for HVAC systems in buildings. This simulation is intended to 
              give you a high-level overview of how SaverX operates in a typical deployment scenario.
            </p>
